    ...
    public class TestDataInitializer : DropCreateDatabaseIfModelChanges<QuestDbContext>
    {
        ...
        private void InitMatheFragen(QuestDbContext context)
        {
            ...
            question = new Question
            {
                ...
                Title = "Mathematik",
                Text = "Ordnen Sie dem Funktionsgraphen die richtige Funktionsgleichung zu.",
                Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            question = new Question
            {
                ...
                Reihenfolge = ++i,
                Title = "Mathematik",
                Text = "Was ist die Lösung der folgenden Gleichung: 2(3x - 4) + 10 = 4x - 6",
                Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            question = new Question
            {
                ...
                Reihenfolge = ++i,
                Title = "Mathematik",
                Text = "Was ist die Ableitung der folgenden Funktion nach x: f(x) = 3 + 4x + 9a²",
                Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            j = 0; question = new Question
             {
                 ...
                 Reihenfolge = ++i,
                 Title = "Technik",
                 Text = "Ein Vater und seine Tochter sitzen auf einer Wippe. Der Vater ist doppelt so schwer wie seine Tochter. Wie müssen sich Vater und Tochter auf der Wippe platzieren, um sie im Gleichgewicht zu halten?",
                 Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            j = 0; question = new Question
             {
                ...
                Text = "Welcher der folgenden drei Körper kann aus der Faltvorlage oben gebildet werden?",
                 Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            j = 0; question = new Question
             {
                 ...
                 Title = "Technik",
                 Text = "Mit welcher Stange erfordert es am meisten Kraft, das angeklebte Rechteck anzuheben?",
                 Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            question = new Question
             {
                 ...
                 Reihenfolge = ++i,
                 Title = "Wirtschaft",
                 Text = "Eine Maschine liefert 4000 Stück pro Tag. Durch eine Investition von 36.000 Euro würde diese Maschine 100 Stück pro Tag mehr produzieren. Der Gewinn pro Stück liegt bei 1,50 Euro. Nach wie vielen Tagen hat sich die Investition amortisiert?",
                 Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            question = new Question
             {
                 ...
                 Reihenfolge = ++i,
                 Title = "Wirtschaft",
                 Text = "Ein Autohersteller möchte seine Produktpalette um ein neues Modell erweitern. Die jährlichen fixen Kosten (=Kosten die in der Höhe unabhängig von der produzierten Menge sind) betragen 1.000.000 €. Pro Auto fallen zusätzlich 10.000 € an Produktionskosten und Vertriebskosten an. Der angenommene Nettoverkaufspreis pro Auto beträgt 15.000 €. Wie viele Autos der neuen Modellreihe muss der Autohersteller pro Jahr mindestens verkaufen, um keinen Verlust durch die Erweiterung der Produktpalette zu machen?",
                 Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            j = 0; question = new Question
             {
                 ...
                 Reihenfolge = ++i,
                 Title = "Wirtschaft",
                 Text = "Die Mehrwertsteuer wurde in Deutschland am 01.01.2007 von 16% auf 19% erhöht. Ein Produkt kostete nach der Erhöhung genau 5.950 Euro. Wie groß ist die Preiserhöhung durch die Änderung des Steuersatzes bei diesem Produkt (gerundet)?",
                 Answers = new List<QuestionAnswer>
                {
                    new QuestionAnswer
                    {
            ...
            j = 0; question = new Question
             {
                 ...
                 Answers = new List<QuestionAnswer>
                {
                    ...
                    new QuestionAnswer
                    {
                        Text = "sich nicht vorhersagen lässt.",
                        IsCorrect = false, Reihenfolge = ++j
                    },
                }
             };
